...
/**
 * Created by Developer on 25.03.2016.
 */
...
public class TreeTableViewDragAndDropDemo extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        tree.setRowFactory(new Callback<TreeTableView<Map<String, Object>>, TreeTableRow<Map<String, Object>>>() {
            @Override
            public TreeTableRow<Map<String, Object>> call(TreeTableView<Map<String, Object>> view) {
                return TreeTableViewDragAndDropDemo.this.rowFactory(view);
            }
        });
    ...
    private void setupScrolling() {
        ...
        scrolltimeline.getKeyFrames().add(new KeyFrame(Duration.millis(20), "Scoll", new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent ActionEvent) {
                TreeTableViewDragAndDropDemo.this.dragScroll();
            }
        }));
